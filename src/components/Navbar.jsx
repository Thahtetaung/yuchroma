                ...
                <div className='dark:bg-gray-900'>
                    ...
                    <div id='navbar_rightcontainer'>
                        <ul className="flex space-x-4">
                            <li><Link to='/' className='navbar_rightitems' onClick={closeDropdown}>Home</Link></li>
                             <li
                            ...
                            {isDropdownOpen && (
                                <ul className="absolute left-0 mt-2 w-48 bg-white text-black dark:bg-gray-900 dark:text-white shadow-2xl rounded-md z-10 space-y-2 p-2">
                            ...
                            <li><Link to='/aboutme' className='navbar_rightitems' onClick={closeDropdown}>About me</Link></li>
                            <li><Link to='/hireme' className='navbar_rightitems' onClick={closeDropdown}>Hire me</Link></li>
                        ...
                        <button onClick={() => setIsDark(!isDark)} className='flex items-center p-2 text-2xl'>{isDark ? <GoSun /> : <GoMoon />} </button>
                    </div> 
                </div>
            {/* Mobile Navigation */}
                {isOpen && (
